...
map.getView().fit([11889329.079160, -697123.019258, 11891140.574038, -695763.497517], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">URBAN+ INSTITUTE x LABTANYA</h2>';
        return titleElement;
    })(),
